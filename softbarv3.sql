...
CREATE TABLE `inventarios` (
  ...
  `producto` tinyblob DEFAULT NULL,
...
CREATE TABLE `productos` (
  ...
  KEY `FK8s4oc6v7fmbfwe2797ohp13ow` (`id_pedido`),
  KEY `FK3h3n05ct5ei1kghbnqs05bhne` (`id_inventario`),
  ...
  CONSTRAINT `FK3h3n05ct5ei1kghbnqs05bhne` FOREIGN KEY (`id_inventario`) REFERENCES `inventarios` (`id_inventario`),
  CONSTRAINT `FK8s4oc6v7fmbfwe2797ohp13ow` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`),
...
CREATE TABLE `usuarios` (
  ...
  KEY `FKnqsh1kd7ybg20un54ucpcg056` (`nombre_rol`),
  ...
  CONSTRAINT `FKnqsh1kd7ybg20un54ucpcg056` FOREIGN KEY (`nombre_rol`) REFERENCES `roles` (`id_rol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-10-20  9:03:43
